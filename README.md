# homepi — Raspberry Pi 5 Edge IoT Gateway

> Full-stack edge IoT platform built on a Raspberry Pi 5 — encrypted NVMe, isolated IoT network, local DNS, Zero-Trust VPN, AI inference, and smart home services.
